...
sudo -iu dragon ansible-playbook -i testbed-iam-manager.osism.test, /opt/manager-part-1.yml -e @/opt/manager.yml
sudo -iu dragon ansible-playbook -i testbed-iam-manager.osism.test, /opt/manager-part-2.yml -e @/opt/manager.yml
sudo -iu dragon ansible-playbook -i testbed-iam-manager.osism.test, /opt/manager-part-3.yml -e @/opt/manager.yml
